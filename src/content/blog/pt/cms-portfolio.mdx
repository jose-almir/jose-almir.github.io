...
<Quote>
  A ideia de conteúdo gerenciado por arquivos não era nova pra mim, mas este
  portfólio foi a oportunidade de levar o conceito a outro nível: construir um
  CMS simples, usando o próprio repositório GitHub como banco de dados.
</Quote>
...
```mermaid
---
title: Arquitetura de Integração do CMS com o GitHub
---
flowchart LR
    CMS["CMS Admin"]
    GH["GitHub (Repositório)"]
    PORT["Portfólio<br/>(Next.js • SCSS • i18n)"]
    GHP["GitHub Pages"]

    CMS -- "Publica conteúdo" --> GH
    CMS -- "Webhooks / API" --> GH
    GH -- "Build" --> PORT
    PORT -- "Push/Deploy" --> GH
    PORT --> GHP
...
<ArticleImage
  ...
  alt="Print do CMS privado"
  caption="Painel de administração onde o conteúdo é gerido de forma simples"
  size="full"
/>
...
<ArticleImage
  ...
  alt="Print do commits do CMS"
  caption="Cada alteração no painel gera um commit automático no repositório, mantendo histórico"
  size="medium"
/>
...
No final, o que mais importa é que a tecnologia continue invisível para o usuário. Minha namorada adiciona uma HQ nova, o site atualiza, e ela não precisa saber nada sobre APIs ou commits para que isso aconteça. É a parte que mais me dá orgulho nesse projeto.

Confira o resultado do portfólio rodando na prática abaixo:

<Preview
  title="Arântia Art"
  src="https://arantia.art/pt"
  github="https://github.com/arantxa-portfolio/arantxa-portfolio.github.io"
/>
