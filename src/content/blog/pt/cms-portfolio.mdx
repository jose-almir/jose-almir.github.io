...
<ArticleImage
  ...
  alt="Print do portfólio"
  caption="Print do portfólio público, que exibe as artes e projetos da Arântia"
  size="full"
/>
...
<ArticleImage
  src="/diagrams/cms-portfolio.md-0.svg"
  alt="Diagrama da arquitetura do projeto"
  caption="Diagrama simplificado da arquitetura: o CMS se comunica diretamente com a API REST do GitHub."
  size="medium"
/>
