...
```mermaid
---
title: CMS and GitHub Integration Architecture
---
flowchart LR
    CMS["CMS Admin"]
    GH["GitHub (Repository)"]
    PORT["Portfolio<br/>(Next.js • SCSS • i18n)"]
    GHP["GitHub Pages"]

    CMS -- "Publishes content" --> GH
    CMS -- "Webhooks / API" --> GH
    GH -- "Build" --> PORT
    PORT -- "Push/Deploy" --> GH
    PORT --> GHP
...
Check out the live portfolio below:

<Preview
  title="Arântia Art"
  src="https://arantia.art/en"
