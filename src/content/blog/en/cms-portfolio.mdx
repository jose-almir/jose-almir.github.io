...
<Quote>
  The idea of file-managed content was not new to me, but this portfolio was the
  opportunity to take the concept to another level: building a simple CMS using
  the GitHub repository itself as a database.
</Quote>
...
<ArticleImage
  ...
  caption="Screenshot of the public portfolio displaying Arântia's arts and projects"
  size="full"
/>
...
<ArticleImage
  ...
  caption="Simplified architecture diagram: the CMS communicates directly with the GitHub REST API."
  size="medium"
/>
...
<ArticleImage
  ...
  alt="Private CMS screenshot"
  caption="Admin panel where content is easily managed"
  size="full"
/>
...
<ArticleImage
  ...
  alt="CMS commits screenshot"
  caption="Every change in the panel generates an automatic commit to the repository, maintaining history"
  size="medium"
/>
