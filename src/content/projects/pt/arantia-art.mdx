...
<ArticleImage
  ...
  alt="Interface do CMS"
  caption="Interface do CMS"
  size="full"
/>

<ArticleImage
  src="/blog/cms-portfolio/cms-commits.png"
  alt="Fluxo de Commits Automatizados"
  caption="Fluxo de Commits Automatizados"
  size="medium"
/>

<ArticleImage
  src="/blog/cms-portfolio/portfolio-print.png"
  alt="Portfólio em Operação"
  caption="Portfólio em Operação"
  size="full"
/>
