...
## Testing Strategy
> TODO: Add testing framework details (e.g., Vitest for utilities, Playwright for E2E). Currently, testing relies on strict TypeScript compilation and ESLint static analysis.
...
* > TODO: Link to specific project ADRs (Architecture Decision Records) once established.
